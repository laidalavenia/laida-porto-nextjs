...
export const ExperienceCard = ({
  ...
  icon,
  isLeft,
  logoSrc = "/api/placeholder/40/40", // Default placeholder
  hasWhiteLogoBg,
}: ExperienceCardProps) => {
  ...
  // Convert description string to bullet points array if it's a string
            ...
            <div className="flex items-center mb-3 gap-3">
              ...
              <div
                className={`w-10 h-10 rounded-lg flex-shrink-0 flex items-center justify-center ${
                  hasWhiteLogoBg ? "bg-white" : "bg-white/10"
                }`}
              >
                <Image
                  src={logoSrc}
