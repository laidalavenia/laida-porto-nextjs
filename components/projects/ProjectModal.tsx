...
export const ProjectModal = ({
  ...
  return (
    // Pindahkan FollowerPointerCard ke dalam overlay modal dengan z-index tinggi
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <FollowerPointerCard title="Laida Space" className="w-full max-w-4xl">
        <div className="bg-gray-900 rounded-2xl w-full max-h-[90vh] overflow-y-auto">
          {/* Header */}
